...
exports.sendTx = exports.buildAndSendTx = exports.mkMrktHigh = exports.createMarket = exports.MARKET_STATE_LAYOUT_V2 = void 0;
...
function makeCreateMarketInstruction({ connection, wallet, marketInfo, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        ins2.push(web3_js_1.SystemProgram.createAccountWithSeed({
            ...
            lamports: yield connection.getMinimumBalanceForRentExemption(5084), // CHANGE
            space: 5084, // CHANGE
            programId: marketInfo.programId,
        }), web3_js_1.SystemProgram.createAccountWithSeed({
            fromPubkey: wallet,
            ...
            lamports: yield connection.getMinimumBalanceForRentExemption(262108), // CHANGE
            space: 262108, // CHANGE
            programId: marketInfo.programId,
        }), web3_js_1.SystemProgram.createAccountWithSeed({
            fromPubkey: wallet,
            ...
            lamports: yield connection.getMinimumBalanceForRentExemption(65500), // CHANGE
            space: 65500, // CHANGE
            programId: marketInfo.programId,
        }), web3_js_1.SystemProgram.createAccountWithSeed({
            fromPubkey: wallet,
